<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="carousel slide" id="carousel-574389">
                <ol class="carousel-indicators">
                    <li data-slide-to="0" data-target="#carousel-574389">
                    </li>
                    <li data-slide-to="1" data-target="#carousel-574389" class="active">
                    </li>
                    <li data-slide-to="2" data-target="#carousel-574389">
                    </li>
                </ol>
